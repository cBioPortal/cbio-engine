...
@Service
public class CBioEngineServiceImpl implements CBioEngineService
{
    private final ClinicalRecordRepository clinicalRecordRepository;
    private final GenomicRecordRepository genomicRecordRepository;

    @Autowired
    public CBioEngineServiceImpl(ClinicalRecordRepository clinicalRecordRepository,
    ...
    {
        ClinicalRecord sampleRecord = clinicalRecordRepository.findOne(sampleId);
    }
}
